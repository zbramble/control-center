...
/**
 * send query BI data to BI system
 * 
 * @author zhangbo
 *
 */
@Component("sendQueryBIDataTask")
public class SendQueryBIDataTask {
    ...
    public void execute() {
        if (!schedulerConfiguration.isBiOnSwitch()
                || !"Timer".equals(schedulerConfiguration
        ...
        while (biParam != null) {
            ...
            try {
                ...
                debugLogger.info("bi data: {}", biRootJson.toString()); // TODO
