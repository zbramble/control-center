 ...
 *
 */
public class SearchByIdStrategy implements
    ...
    public SearchResult excute(SearchParam searchParam) {
        ...
        postData.add(new BasicNameValuePair("user", schedulerConfiguration
                .getSystemDataConfiguration().getSearchQueryByIdUser()));
        postData.add(new BasicNameValuePair("token", schedulerConfiguration
                .getSystemDataConfiguration().getSearchQueryByIdToken()));
        postData.add(new BasicNameValuePair("ids", searchParam.getIds()));
        ...
        try {
            ...
            if (schedulerConfiguration.getDebugSwitchConfiguration()
                ...
                debugLogger.info("{} {} ISBICHCR: {}", searchParam.getUid(),
            ...
            if (schedulerConfiguration.getDebugSwitchConfiguration()
                    .isHttpclientDebugSwitch()) {
                debugLogger.info("{} {} DSBICHCR: {}", searchParam.getUid(),
                        searchParam.getFid(), schedulerControllerStatistics
                                .getCurrentHttpClientRequestNum());
            }
        }
        ...
        if (schedulerConfiguration.getDebugSwitchConfiguration()
            ...
            searchServer.getSearchServerStatistics().addAndGetExecTimeById(
                    excuteTime);
            searchServer.getSearchServerStatistics()
                    .incrementAndGetExecTimeByIdNum();
        }
        if (schedulerConfiguration.getDebugSwitchConfiguration()
                .isSearchByIdServerExecTimeDebugSwitch()) {
            debugLogger.info("{} {} {} SBIET: {}", searchParam.getUid(),
